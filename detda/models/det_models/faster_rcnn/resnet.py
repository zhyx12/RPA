...
class resnet(_fasterRCNN):
    def __init__(self, classes, num_layers=101, pretrained=False, class_agnostic=False):
        self.model_path = osp.join(cfg.ROOT_DIR, 'data', 'pretrained_model', 'resnet{}_caffe.pth'.format(num_layers))
    ...
    def _init_modules(self):
        ...
        self.RCNN_base1 = resnet.layer2
        self.RCNN_base2 = resnet.layer3
        self.RCNN_base3 = nn.Identity()  # placeholder
        #
